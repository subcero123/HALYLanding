    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-900 to-gray-800 text-gray-100">
      ...
      <main>
        ...
        <section id="servicios" className="container mx-auto px-4 py-20">
          <AnimateIn>
            <h2 className="text-3xl font-semibold mb-12 text-center">{t("services.title")}</h2>
          </AnimateIn>
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <AnimateIn key={service.title} delay={0.2 * (index + 1)}>
        ...
        <section className="container mx-auto px-4 py-20">
          <AnimateIn>
            <h2 className="text-3xl font-semibold mb-12 text-center">{t("services.examples.title")}</h2>
          </AnimateIn>
            ...
            {[
              {
                ...
                image: "/placeholder.svg?height=300&width=400&text=E-commerce+Website",
              ...
              },
              {
                ...
                image: "/placeholder.svg?height=300&width=400&text=Fitness+Tracking+App",
              ...
              <AnimateIn key={example.title} delay={0.2 * (index + 1)}>
                  ...
                  <CardContent className="flex-grow flex flex-col justify-between">
                    ...
                    <div className="space-y-4 mt-auto">
                      <div className="flex items-center">
                        ...
                        <h4 className="text-sm font-semibold text-blue-400">{t("services.examples.category")}</h4>
                      </div>
                      <p className="text-gray-300 text-sm ml-7">{example.category}</p>
                      <div className="flex items-center">
                        <Code className="w-5 h-5 text-green-400 mr-2 flex-shrink-0" />
                        <h4 className="text-sm font-semibold text-green-400">{t("services.examples.technologies")}</h4>
                      </div>
                      <div className="flex flex-wrap gap-2 ml-7">
                        {example.technologies.map((tech, i) => (
                          <div key={i} className="flex items-center bg-gray-700 rounded-full px-2 py-1">
                            {getTechIcon(tech)}
        ...
        <AnimateIn>
          <section id="contacto" className="bg-gray-900 py-20">
            <div className="container mx-auto px-4">
              <h2 className="text-3xl font-semibold mb-12 text-center">{t("contact.title")}</h2>
              <div className="grid md:grid-cols-2 gap-12">
                ...
                <AnimateIn direction="right">
                  <Card className="bg-gray-800 border-gray-700">
                    <CardHeader>
                      <CardTitle className="text-white">{t("contact.subtitle")}</CardTitle>
                      <CardDescription className="text-gray-300">{t("contact.description")}</CardDescription>
                    </CardHeader>
                    <CardContent>
                      <ContactForm />
                    </CardContent>
